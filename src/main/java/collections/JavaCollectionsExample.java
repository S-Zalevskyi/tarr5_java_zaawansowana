...
//            names[100] = "Jan";         // może zgłaszać - > ArrayIndexOutOfBoundsException
    ...
    public Set<String> getUniqueRoles(){
        /*Здесь мы создали сбор uniqueRoles и дали ему значение getAllRoles, то есть все значения в двух сборах,
         * потом отняли (removeAll) от этих значений повторяющиеся значения (getNonUniqueRoles т.е. USER).
         *  И получили значения сборов без общих значений.
         * То есть без значения USER*/
    ...
    public void generateValuesIntoMap(){
        ...
        System.out.println(decimalToRoman.keySet());
    }
    ...
    public void receiveMessage () {
        while (!messages.isEmpty()) {
            System.out.println("Odebrano wiadomosc " + messages.removeFirst());
            System.out.println("Pozostale wiadomosci: " + messages);
            try {
